...
const form = useForm({
  ...
  requiere_deposito: props.servicio.requiere_deposito,
  deposito_minimo: props.servicio.deposito_minimo,
    ...
    <div class="container-fluid px-0 px-md-3">
      ...
      <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 gap-3">
        <h1 class="h4 brand-accent fw-bold mb-0">
          <i class="fas fa-edit me-2"></i> Editar Servicio <span class="text-muted fs-5 fw-normal">#{{ servicio.id }}</span>
        </h1>
